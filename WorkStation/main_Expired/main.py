...
def main():
    ...
    textbook2_train_map = load_from_disk(r"C:\junha\Datasets\OpenWebText2\train")
    textbook2_val_map = load_from_disk(r"C:\junha\Datasets\OpenWebText2\val")
    ...
    ckpt_dir = r"/Checkpoints/Rapter150M_Wiki_Book_Web_406M"
    ...
    for epoch in epoch_iter:
        ...
        torch.save(model.state_dict(), os.path.join(ckpt_dir, f"72M_309MD_model_epoch_{epoch}.pt"))
