...
def main():
    ...
    base_model.load_state_dict(torch.load(
        r"C:\junha\Git\BFG_2B\Checkpoints\EnRaptor150M_Wiki2_103_OWT_Book\model_epoch_1.pt"
    ))
    ...
    for epoch in tqdm(range(1, NUM_EPOCHS + 1)):
        ...
        # LoRA 체크포인트 저장
        save_dir = f"C:/junha/Git/BFG_2B/Checkpoints/EnRaptor_Wiki2_103_OWT_Book_Chatbot_checkpoint/epoch_{epoch}"
